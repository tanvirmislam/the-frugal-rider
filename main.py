...
def find_tickets(bus_service_name: str, departure_city: str, arrival_city: str, departure_date: str) -> None:
    ...
    if bus_service_object is None:
        print('Error: unable to get ' + bus_service_name + ' object')
        return
...
def main() -> None:
    find_tickets('Greyhound', 'New York', 'Hartford', '2020-02-15')

    # with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
    #     search_1 = executor.submit(find_tickets, 'Peterpan', 'New York', 'Hartford', '2018-12-27')
    #     search_2 = executor.submit(find_tickets, 'Greyhound', 'New York', 'Hartford', '2018-12-27')
    #
